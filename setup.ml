...
(* OASIS_START *)
(* DO NOT EDIT (digest: a1659640563147dab89105fdf35fd1bd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = [];
          authors =
            ["Siddharth Vinothkumar <siddharth.vinothkumar@citrix.com>"];
          homepage = None;
          synopsis = "Bindings to for readings blktap3 stats files";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Blktap3_stats"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "blktap3-stats";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\021\224\011\174k\146\003_\015\028\210\249\193\rzJ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
